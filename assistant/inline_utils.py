...
**Views :** `{views}`
        ...
        nice_text = f"**🦊 Fox X UserBot Commands** \n**🦊 Fox X Version :** __{friday_version}__ \n**🦊 PyroGram Version :** __{__version__}__ \n**🦊 Total Plugins Loaded :** __{total_}__"
...
async def wow_nice(client, cb):
    ...
    await cb.edit_message_text(
        f"Command List & Help \n**Total Commands :** `{len(v_t)}` \n**(C) [🦊 Fox X Bots](https://t.me/foxxbotofficials)**",
        reply_markup=InlineKeyboardMarkup(bttn),
    )
...
async def get_back_vro(client, cb):
    ...
    nice_text = f"**🦊 Fox X UserBot Commands & Help Menu!** \n\n**🦊 Fox X Version :** __{friday_version}__ \n**🦊 PyroGram Version :** __{__version__}__ \n**🦊 Total Plugins Loaded :** __{len(CMD_LIST)}__"
...
async def give_plugin_cmds(client, cb):
    ...
    help_string += "\n\n**(C) [🦊 Fox X Bots](https://t.me/foxxbotofficials)** ".format(plugin_name)
    await cb.edit_message_text(
        help_string,
        reply_markup=InlineKeyboardMarkup(
            [
